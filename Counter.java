...
public class Counter extends Actor
{
    ...
    private void updateImage()
    {
        ...
        GreenfootImage text = new GreenfootImage(prefix + value, 20, Color.WHITE, transparent);
        
        if (text.getWidth() > image.getWidth() - 10)
        {
            image.scale(text.getWidth() + 10, image.getHeight());
        }
